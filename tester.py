...
def test():
    # load model
    CHECKPOINT_PATH = "/home/zhulin/workspace/Sun/ckpt/ScPredicTask/lightning_logs/version_9/checkpoints/"
    pretrained_filename = os.path.join(CHECKPOINT_PATH, "epoch=126-step=79375.ckpt")
    classifier = ScPredictor.load_from_checkpoint(pretrained_filename)
    trainer = pl.Trainer(enable_checkpointing=False, logger=False)
    classifier.eval()

    TEST_DATASETS_PATH = "/mnt/sdd1/data/sun/cdatasets_test.txt.1"
