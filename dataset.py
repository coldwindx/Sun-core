...
def mc_collate_fn(batch_data):
    ...
    padded_sent_seq_c1 = tokenizer(sent_seq_c1, padding=True, truncation=True, max_length=1000, return_tensors="pt")
    padded_sent_seq_c2 = tokenizer(sent_seq_c2, padding=True, truncation=True, max_length=1000, return_tensors="pt")
    padded_sent_seq_c3 = tokenizer(sent_seq_c3, padding=True, truncation=True, max_length=1000, return_tensors="pt")
    padded_sent_seq_c4 = tokenizer(sent_seq_c4, padding=True, truncation=True, max_length=1000, return_tensors="pt")
